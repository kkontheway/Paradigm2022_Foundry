...
//@audit-info HintFinanceVault 它具有提供Flash Loan功能，并且可以为储存的资产提供奖励。以下是代码分析：
//underlying Token 是基础代币
...
contract HintFinanceVault {
    ...
    //@audit-info deposit函数用于存入资产，用户可以存入资产，然后获得对应的份额
    ...
    //@audit-info withdraw函数用于提取资产，用户可以提取对应份额的资产
